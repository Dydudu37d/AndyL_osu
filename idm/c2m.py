...
# --- 配置 ---
INPUT_DIR = "/cache_local/testgroup01/wangzirui/output_dataset"  # 你原本存放 npz 的地方
OUTPUT_FILE = "/cache_local/testgroup01/wangzirui/dataset_full.memmap" # 生成的超级大文件路径
META_FILE = "/cache_local/testgroup01/wangzirui/dataset_meta.npz"      # 存放元数据(索引/动作)
